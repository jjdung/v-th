...
let s:palette = {}
"mirage bg default is #212733
"mirage fg default is #D9D7CE
let s:palette.bg        = {'dark': "#0F1419",  'light': "#FAFAFA",  'mirage': "#000000"}

let s:palette.comment   = {'dark': "#D75FFF",  'light': "#D75FFF",  'mirage': "#D75FFF"}
...
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#5C6773",  'mirage': "#FFFFFF"}
...
"   Incsearch"
"magenta match pattern default is .s:fmt_undr
exe "hi! MatchParen"    .s:fg_fg          .s:bg_bg          .s:bg_string
